$(document).ready(function() {
  ...
  var apiRoot = 'https://kodilla-mc-tasks.herokuapp.com/v1/tasks';
  ...
  function createElement(data) {
    ...
    element.find('[data-task-content-section] [data-task-content-paragraph]').text(data.description);
    element.find('[data-task-content-section] [data-task-content-input]').val(data.description);
